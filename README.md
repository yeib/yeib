...
- 📁 **[PowerFolder](https://apps.microsoft.com/detail/9NP57T3T4N1F):** Suite todo en uno que unifica las 4 aplicaciones independientes de abajo:
  ...
  - 🔄 **[Conversor Yeib](https://apps.microsoft.com/detail/9NLS4V2NGX5C):** Conversor masivo de archivos offline con extracción de texto OCR.
  - ⚡ **[PowerActions](https://apps.microsoft.com/detail/9MTCP1QWX8ZW):** Automatización de tareas del sistema, renombrado masivo y atajos.
...
- ⚙️ **[Zaraz Studio 2.0 (Zaraz Maker)](https://github.com/yeib/ZarazStudio):** Motor de videojuegos y suite IDE **100% No-Code** diseñado para la creación de juegos de simulación, estrategia y RPG. Construido en **Rust (100% Core) + Tauri v2**, incluye simulación multi-hilo, Utility AI para NPCs, Pathfinding A*, Quadtrees 2D y exportación standalone (.EXE) en 1-clic.

---
<div align="center">
  <i>"Ideas que cobran vida"</i>
</div>
